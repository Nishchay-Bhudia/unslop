...
"""), "docs(skill): add frontmatter and intro")
...
"""), "docs(skill): add core principle guardrail")
...
"""), "docs(skill): define input schema")
...
"""), "docs(skill): add stage 1 diagnose")
...
"""), "docs(skill): add stage 2 extract")
...
"""), "docs(skill): add stage 3 reconstruct (hook framework)")
...
"""), "docs(skill): add stage 4 humanize")
...
"""), "docs(skill): add stage 5 platform adapt")
...
"""), "docs(skill): add stage 6 quality control")
...
"""), "docs(skill): add advanced options")
...
- `references/psychology.md` — the research this skill is built on: curiosity
  ...
  framework.
"""), "docs(skill): add guardrails and reference index")

print("SKILL.md build done")
